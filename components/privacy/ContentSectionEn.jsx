...
const ContentSectionEn = ({ translate, lang }) => {
  ...
  return (
    <>
      ...
      <div className="max-w-screen-2xl mx-auto px-10 text-gray-800 text-lg">
        ...
        <p className="mb-4 leading-relaxed">
          ...
          collected on the <br /> <span className="font-bold">Estajer.com</span>
          . We take this responsibility seriously, so please read this policy
        ...
        <p className="mb-4 leading-relaxed">
          ...
          to help you understand the procedures <br /> and practices we follow
          when collecting any personal data, including but not limited to
          payment details and other data we collect from you or other <br />{" "}
          sources or that you provide to us ("
          <span className="font-bold">Information</span>"), how we use and share
          it, the steps we take to secure this data, and your legal rights and
          obligations and <br /> all other practices.
        </p>
        <p className="mb-4 leading-relaxed">
        ...
        <h2 className="text-3xl font-bold  mb-6">2. Scope of the Policy</h2>
        <p className="mb-4 leading-relaxed">
          2.1.{" "}
        ...
        <p className="mb-4 leading-relaxed">
          ...
          information, data, services, tools, all pages, and other activities we{" "}
          <br />
        ...
        <ul className="list-disc list-inside pl-5 mb-4 space-y-3">
          ...
          <li className="leading-relaxed">
            ...
            devices they use to connect to the website <br /> or related to
          ...
          <li className="leading-relaxed">
            ...
            does not directly relate to an individual, such as usage data <br />{" "}
        ...
        <ul className="list-disc list-inside pl-5 mb-4 space-y-3">
          <li className="leading-relaxed">
            ...
            email) <br /> and other shared registrations (e.g., logging in via
            social media sites) or subscribing to our services, or posting an ad
            for goods or requesting to rent goods.
          </li>
          <li className="leading-relaxed">
          ...
          <li className="leading-relaxed">
            ...
            name, <br /> address, phone number, email address, type of item,
            rental duration, and credit card details, among other information.
          </li>
          <li className="leading-relaxed">
          ...
          <li className="leading-relaxed">
            ...
            or through our website, such as data you provide us,
            <br /> or that we may collect from you, when you inform us of any
            difficulty or problem you encounter when using the site.
          </li>
          <li className="leading-relaxed">
          ...
          <li className="leading-relaxed">
            ...
            cookies, <br /> conversion tracking code, and web beacons
        ...
        <p className="mb-4 leading-relaxed">
          ...
          activities carried out through your use of the platform and services.{" "}
          <br />
          ...
          the services,
          <br /> you represent that you have the authority to do so and permit
          us to use the data in accordance with this policy.
        </p>
        ...
        <ul className="list-disc list-inside pl-5 mb-4 space-y-3">
          ...
          <li className="leading-relaxed">
            ...
            our business or the businesses of third parties which we <br />{" "}
            think may be of interest to you, or if you have specifically agreed
            to this, by email or similar technology (you can inform us at any
            time if you no longer require these marketing communications).
          </li>
          <li className="leading-relaxed">
          ...
          <li className="leading-relaxed">
            ...
            of our website (including monitoring private messages sent <br />{" "}
            through our website's private messaging service).
          </li>
          <li className="leading-relaxed">
        ...
        <ul className="list-disc list-inside pl-5 mb-4 space-y-3">
          <li className="leading-relaxed">
            ...
            and all its branches to the extent reasonably necessary <br /> for
          ...
          <li className="leading-relaxed">
            ...
            and information technology providers, advertising, and electronic
            communication.
          </li>
          <li className="leading-relaxed">
            ...
            electronic payment <br /> process you make through us, secure it,
            and process refunds to you.
          </li>
          <li className="leading-relaxed">
            ...
            requests <br /> and legal procedures regarding any ongoing or
            prospective legal proceedings or in order to establish, exercise or
            defend our legal rights <br /> (including providing information to
            others for the purposes of fraud prevention and reducing credit
            risk).
          </li>
          <li className="leading-relaxed">
          ...
          <li className="leading-relaxed">
            ...
            personal information where, <br /> in our reasonable opinion, such
            court or authority would be reasonably likely to order disclosure of
            that personal information. Except as provided in <br /> this policy,
        ...
        <p className="mb-4 leading-relaxed">
          ...
          services. <br /> Please note that the use of your personal data by any
          third parties will be subject to their own privacy policies; we
          recommend
          <br />
        ...
        <p className="mb-4 leading-relaxed">
          ...
          us to use <br /> the information in accordance with this policy, and
          kept outside your state, province, country, or other governmental
          jurisdiction where the data protection laws <br /> may differ from
        ...
        <p className="mb-4 leading-relaxed">
          ...
          on our website <br /> and which is available via the internet
        ...
        <p className="mb-4 leading-relaxed">
          ...
          <span className="font-bold">Estajer.com</span> for any purpose <br />{" "}
          or purposes for longer than is necessary for that purpose or those
          purposes.
        </p>
        <p className="mb-4 leading-relaxed">
          7.3.{" "}
          ...
          period necessary to achieve the purposes of collection. <br /> Please
          be aware that in some cases, laws may require or permit us to retain
          such data for a longer period. We also retain your account-related
          data in electronic records <br /> as long as you remain a user of{" "}
        ...
        <p className="mb-4 leading-relaxed">
          ...
          although we will do our best to protect your data, <br /> we cannot
          guarantee the security of data transmitted to{" "}
        ...
        <p className="mb-4 leading-relaxed">
          ...
          users' personal information has been disclosed to third parties <br />{" "}
          as a result of external activity, including, but not limited to,
          electronic security attacks or fraud, we reserve the right to take
          appropriate <br />
        ...
        <p className="mb-4 leading-relaxed">
          ...
          users and visitors of <span className="font-bold">Estajer.com</span>.{" "}
          <br />
          ...
          and visitors of the site, <br /> and it will not be customized for
        ...
        <p className="mb-4 leading-relaxed">
          ...
          information for marketing purposes. <br /> In practice, you will
          usually either expressly agree in advance to our use of your personal
          information for marketing purposes, <br /> or we will provide you with
          an opportunity to opt-out of the use of your personal information for
          marketing purposes.
        </p>

        <h2 className="text-3xl font-bold mb-6">13. Managing Your Privacy</h2>
        <p className="mb-4 leading-relaxed">
        ...
        <p className="mb-4 leading-relaxed">
          ...
          confidentiality of your personal information <br /> or for actions
          resulting from third-party access to your information and personal
          data.
        </p>
        ...
        <p className="mb-4 leading-relaxed">
          ...
          belonging to third parties. <br /> Please be aware that we have no
          control over the privacy policies and practices of third parties, and
        ...
        <p className="mb-4 leading-relaxed">
          ...
          platforms, <br /> such as Twitter, Instagram, or any social media
          platform provider, operating system provider, wireless service
          provider, or device manufacturer. <br /> We recommend that you review
          the privacy policies of these institutions and sites carefully to
          understand your rights and obligations better.
        </p>

        <h2 className="text-3xl font-bold mb-6">15. Cookies</h2>
        <p className="mb-4 leading-relaxed">
          15.1. A cookie is a file containing an identifier (a string of letters
          and numbers) that is sent by a web server to a web browser <br /> and
        ...
        <p className="mb-4 leading-relaxed">
          ...
          security, <br /> facilitate navigation, display material more
          efficiently, recognize your device when you access services,
          understand how you use them, <br /> measure the effectiveness of
          advertisements, and track and target your interests.
        </p>
        <p className="mb-4 leading-relaxed">
        ...
        <ul className="list-disc list-inside pl-5 mb-4 space-y-3">
          ...
          <li className="leading-relaxed">
            ...
            website, recognize visitors, track users as they navigate the site,{" "}
            <br />
            improve the site's usability, analyze site usage by tracking visitor
            movements, pages visited, provide statistics about site usage,{" "}
            <br />
        ...
        <p className="mb-4 leading-relaxed">
          ...
          the settings in your browser. <br />
        ...
        <p className="mb-4 leading-relaxed">
          ...
          reserves the right to make amendments, changes, <br /> or updates to
          this policy at any time as necessary and appropriate to include
          prevailing practices on <span className="font-bold">Estajer.com</span>
          , or regulatory requirements or other purposes.
        </p>
        <p className="mb-4 leading-relaxed">
          ...
          policy <br /> is posted constitutes your agreement to all such
          changes.
        </p>
        <p className="mb-4 leading-relaxed">
        ...
        <p className="mb-4 leading-relaxed">
          ...
          are your responsibility. <br /> If you provide us with any data
          related to a person other than the account holder, you are responsible
          to us, to the competent authorities, and to the affected person, and
          you undertake to pay all appropriate compensation.
        </p>
        <p className="mb-4 leading-relaxed">
          17.2. You acknowledge and agree to read this policy and abide by all
          its terms and conditions. <br /> Your continued use of the site or
          services is considered your agreement to comply with this policy.
        </p>
