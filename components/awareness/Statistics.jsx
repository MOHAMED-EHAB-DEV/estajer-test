  ...
  return (
    <section className="pt-16 md:pt-28 pb-8 md:pb-10 px-4 md:px-8 relative bg-white">
      <div className="max-w-screen-2xl mx-auto text-center relative z-10 w-full">
        ...
        {/* Subtitle */}
        <p className="text-mutedGray lg:text-1.1 md:text-1.2 px-2 text-sm md:mb-16 mb-8 max-w-3xl mx-auto font-IBMPlex leading-relaxed">
          {t("description")}
        ...
        <div className="flex justify-center">
          ...
          >
            <span>
              {lang === "ar"
                ? "انضم لـ 800+ شريك ناجح"
                : "Join 800+ successful partners"}
            </span>
