...
const AddReviewModal = dynamic(() => import("./AddReviewModal"), {
  ssr: false,
});
...
function ReviewsContainer({
  ...
  return (
    <section className="mt-6 md:mt-10" aria-label={t("title")}>
      {initialReviews?.total > 0 && (
        <>
          <header className="mb-4 md:mb-6">
            <h2 className="text-darkNavy font-semibold text-base md:text-[1.5rem] lg:text-1.75 mb-1 md:mb-2">
