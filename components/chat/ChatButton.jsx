  ...
  return (
    <div id="chat-button" className={home ? "mx-auto md:mx-0" : "md:ms-auto"}>
      <Button
        className={`${
          profile
            ? "bg-[#f28e2b] hover:bg-[#e07d24] px-6 py-2.5 h-auto text-0.85"
            : home
              ? "bg-darkNavy md:py-4 py-3 h-auto md:ps-6 ps-3 pe-4 md:pe-8 text-[0.75rem] md:text-1.1"
              : "bg-darkNavy md:ps-10 md:pe-12 ps-3 pe-4 md:py-4 py-3 h-auto text-[0.75rem] md:text-1.1"
        } gap-2`}
        onPress={handelOpenChat}
      >
        <Chat
          className={`${profile ? "w-4 h-4" : "md:w-7 md:h-5 w-4 h-4"} `}
          fill="#fff"
        />
        {t("chatButton")}
      </Button>
