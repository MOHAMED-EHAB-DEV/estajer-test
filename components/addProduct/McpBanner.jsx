  ...
  return (
    <>
      <button
        ...
        type="button"
        className="hidden md:flex fixed bottom-7 start-6 z-50 items-center justify-center gap-1 rounded-full bg-gradient-to-r from-amber-500 to-orange-500 text-white shadow-2xl transition-all hover:scale-105 active:scale-95 border border-white/20 select-none group font-IBMPlex p-4 sm:px-5 sm:py-3.5"
      >
        <svg
      ...
      <CustomModal
        ...
        className="!p-0 border border-slate-100 shadow-2xl overflow-hidden text-start"
      >
        {/* Header */}
      ...
      <CustomModal
        ...
        size="xl"
        hideCloseButton={true}
        className="!p-6 md:!p-8 border border-slate-100 shadow-2xl rounded-3xl overflow-y-auto max-h-[90vh] text-start"
      >
