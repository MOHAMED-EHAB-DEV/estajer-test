  ...
  return (
    ...
    >
      <div className="py-4 px-6 flex flex-col h-full">
        {/* Header */}
        <div className="flex justify-between items-center border-b py-6 flex-shrink-0">
          {user ? (
            <div className="flex items-center gap-20 w-full px-4">
              <Link
                ...
                onClick={handleClose}
              >
                <svg width="32" height="30" viewBox="0 0 32 30" fill="#0D092B">
              ...
              <Link
                ...
                onClick={handleClose}
              >
                <svg width="31" height="28" viewBox="0 0 31 28" fill="#0D092B">
                  <path
