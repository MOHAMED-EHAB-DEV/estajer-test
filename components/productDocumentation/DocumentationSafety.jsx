  ...
  return (
    <div>
      <div className="border-[#F48A42] border rounded-2xl overflow-hidden">
        <div className="flex gap-4 py-7 justify-center items-center bg-[#FCE7C5] font-semibold text-darkNavy text-[1.6rem] md:text-[1.8rem] lg:text-1.9">
          <Warning className="lg:w-10 lg:h-10 w-6 h-6" />
          <span>{t("title")}</span>
        </div>
        <div className="bg-[#EAEEF34D] xl:px-8 p-6 py-8 lg:text-xl md:text-lg text-mutedGray">
          <ul>
            <li className="flex gap-4 mb-1">
              <span className="min-w-2 mt-[0.75rem] h-2 rounded-full bg-mutedGray P-4 flex"></span>
