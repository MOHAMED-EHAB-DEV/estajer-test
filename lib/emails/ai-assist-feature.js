...
export async function sendAiAssistFeatureEmail({
  ...
  const emailSubject = isEn
    ? `Add products instantly with AI on Estajer | New Feature`
    : `اكتشف كيف تضيف منتجك بالذكاء الاصطناعي على استأجر | ميزة جديدة`;
                        ...
                        <tr>
                            <td class="email-body">
                                ...
                                <p>
                                    ${
                                      isEn
                                        ? `Tutorial video for using the new AI feature: <a href="https://www.youtube.com/watch?v=Ss8Udvi1s5U" target="_blank" style="color: #F48A42 !important; text-decoration: underline !important; font-weight: bold; font-size: 16px;">Watch on YouTube</a>`
                                        : `فديو توضيحي لكيفية استخدام ميزة الذكاء الاصطناعي الجديدة: <a href="https://www.youtube.com/watch?v=Ss8Udvi1s5U" target="_blank" style="color: #F48A42 !important; text-decoration: underline !important; font-weight: bold; font-size: 16px;">مشاهدة على يوتيوب</a>`
                                    }
                                </p>
