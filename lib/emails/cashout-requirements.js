  ...
  const requirementsList =
    userLang === "en"
      ? `<ul style="margin: 0 0 18px 0; padding-left: 20px; font-family: sans-serif;">
         ...
         <li style="margin-bottom: 8px; font-family: sans-serif;">🏢 <strong>National Address:</strong> Required for tax invoice generation (for tax-registered companies).</li>
       </ul>`
      : `<ul style="margin: 0 0 18px 0; padding-right: 20px; font-family: sans-serif;">
         ...
         <li style="margin-bottom: 8px; font-family: sans-serif;">🏢 <strong>العنوان الوطني:</strong> مطلوب لإصدار الفواتير الضريبية (للشركات المسجلة ضريبياً).</li>
       </ul>`;
